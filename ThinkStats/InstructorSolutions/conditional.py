...
Modifications by Jim Stearns, 2 May 2014:
- Added from clause to import. Shouldn't need to do this. Learn about Python path.
- Added parentheses around print parameters for Python 3
- Added ability to pass data directory into main program.
"""

from InstructorSolutions import descriptive
from InstructorSolutions import risk
