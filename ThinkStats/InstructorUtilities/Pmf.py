...
Modifications
14-Apr-2014 jms Modified print statements to be Python 3 conformant (added parentheses).
15-Apr-2014 jms Modified nine occurrences of iteritems to items and two of itervalues to values, for Python 3
"""
